  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col group transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
      <div className="relative">
        <button onClick={() => onStoryClick(story.id)} className="block w-full">
            <img 
              src={story.imageUrl} 
              alt={story.title}
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="text-lg font-bold text-gray-800 mb-2 leading-tight">
          <a href="#" onClick={(e) => { e.preventDefault(); onStoryClick(story.id); }} className="hover:text-blue-600 transition-colors">
            {story.title}
          </a>
        </h3>
